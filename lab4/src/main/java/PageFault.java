...
public class PageFault {
  ...
  public static void replacePageNRU(Vector mem , int virtPageNum , int replacePageNum , ControlPanel controlPanel) {
    int minRM = 100;
    int index = -1;
    ...
    Page toKick = (Page) mem.elementAt(index);
    Page nextpage = (Page) mem.elementAt(replacePageNum);
    controlPanel.removePhysicalPage(index);
    nextpage.physical = toKick.physical;
    controlPanel.addPhysicalPage(nextpage.physical, replacePageNum);
    toKick.inMemTime = 0;
    toKick.lastTouchTime = 0;
    toKick.R = 0;
    toKick.M = 0;
    toKick.physical = -1;
  }
